...
public class AtifActivity extends AppCompatActivity {
    ListView listView;
    private SearchView searchView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_atif);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (selectedSongName.equals("I Knew You Were Trouble" + "\n(Taylor swift)")){
                    ...
                    startActivity(new Intent(AtifActivity.this, MusicPlayerActivity.class));
                }
                else if (selectedSongName.equals("Faded" + "\n(Alan walker)")){

                    startActivity(new Intent(AtifActivity.this, song2.class));
                }
                else if (selectedSongName.equals("Hamdard" + "\n(Arijit singh)")){

                    startActivity(new Intent(AtifActivity.this, song3.class));
                }
                else if(selectedSongName.equals("Snow On The Beach" + "\n(Taylor swift)")){

                    startActivity(new Intent(AtifActivity.this, song4.class));
                }
                else if (selectedSongName.equals("Fitoori" + "\n(Shreya ghoshal)")){

                    startActivity(new Intent(AtifActivity.this, song5.class));
                }
                else if (selectedSongName.equals("Pinga" + "\n(Shreya ghosal)")){

                    startActivity(new Intent(AtifActivity.this, song6.class));
                }
                else  if (selectedSongName.equals("O Re Piya" + "\n(Atif Alslam)")){

                    startActivity(new Intent(AtifActivity.this, song7.class));
                }
                else  if (selectedSongName.equals("Baby Calm Down" + "\n(Rema)")){

                    startActivity(new Intent(AtifActivity.this, song8.class));
                }
                else  if (selectedSongName.equals("Shape Of You" + "\n(Ed shareen)")) {

                    startActivity(new Intent(AtifActivity.this, song9.class));
                }
                else  if (selectedSongName.equals("Despacito" + "\n(Luis Fonsi)")){

                    startActivity(new Intent(AtifActivity.this, song10.class));
                }
                else if (selectedSongName.equals("Pasoori" + "\n(Shae Gill, Ali Sethi)")){

                    startActivity(new Intent(AtifActivity.this, song11.class));
                }
                else  if (selectedSongName.equals("Bheega Bheega Ye Sama" + "\n(Lata Mangeshkar)")){

                    startActivity(new Intent(AtifActivity.this, song12.class));
                }
                else  if (selectedSongName.equals("Jab Tak" + "\n(Armaan Malik)")){

                    startActivity(new Intent(AtifActivity.this, song13.class));

                }  else  if (selectedSongName.equals("Haye Rama" + "\n(Hariharan, Swarnalatha)")){

                    startActivity(new Intent(AtifActivity.this, song14.class));

                }  else  if (selectedSongName.equals("Sawan Aya He" + "\n(Arijit Singh)")){

                    startActivity(new Intent(AtifActivity.this, song15.class));
                }
