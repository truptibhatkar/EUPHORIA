...
public class song15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playPauseButton = findViewById(R.id.playPauseButton);
         ...
         mediaplayer1 = MediaPlayer.create(this, R.raw.mohabbat);
        ...
        MusicHolder1(); {
            ...
            backbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(song15.this, song14.class));
                    finish();
                }
            });
            ...
            forward.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(song15.this, MusicPlayerActivity.class));
                    finish();
